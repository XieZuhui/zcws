    ...
    <div class="row clearfix">
        <div class="col-sm-3 col-md-3 column">
                ...
                <div class="col-md-12">
                    <div class="thumbnail" style="    border-radius: 0px;">
                        ...
                        <div class="caption" style="text-align:center;">
                            ...
                            <c:choose>
                                <c:when test="${loginedUser.authstatus == 0}">
                                     <span class="label label-danger" style="cursor:pointer;" onclick="window.location.href='accttype.jsp'">
                                未实名认证</span>
                                </c:when>
                                <c:when test="${loginedUser.authstatus == 1}">
                                    <span class="label label-danger" style="cursor:pointer;" >
                                 实名认证中</span>
                                </c:when>
                                <c:when test="${loginedUser.authstatus == 2}">
                                     <span class="label label-danger" style="cursor:pointer;" >
                                 已实名认证</span>
                                </c:when>
                            </c:choose>
            ...
            <div class="list-group">
                ...
                <div class="list-group-item " style="cursor:pointer;" onclick="window.location.href='minezc.jsp'">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <div id="footer">
                ...
                <div class="copyRight">
                    Copyright ?2019-2019 zc.com 版权所有
                </div>
            </div>
